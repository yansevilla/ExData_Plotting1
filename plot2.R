...
#Plot x-y plot to screen.
par(mfrow = c(1, 1)) #Initialize plot row column numbers
plot(two_day_data$`date_and_time[two_days_indices]`,two_day_data$Global_active_power,type = "l",xlab = "",ylab="Global Active Power (kilowatts)")
